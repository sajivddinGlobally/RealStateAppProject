  ...
  final List<Map<String, String>> _onboardingData = [
    {
      ...
      "description":
          "Explore verified properties for buying, selling, and renting with complete details and trusted listings.",
    },
    {
      "title": "🛠️ Home Services",
      "description":
          "Book electricians, plumbers, cleaners, painters, and other professional home services anytime.",
    },
    {
      "title": "💰 Loans Made Simple",
      "description":
          "Apply for home and personal loans, compare offers, calculate EMIs, and get financial support easily.",
    },
  ];
  ...
  void _nextPage() {
    if (_currentPage < 2) {
      ...
      Navigator.pushReplacement(
        context,
        CupertinoPageRoute(builder: (context) => LoginPageWithOtp()),
      );
    }
  }
